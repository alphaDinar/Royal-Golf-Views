    ...
    <main className={styles.aboutBox}>
      ...
      <section className={styles.infoBox}>
        <article>
          ...
          <p>
            <strong>
              Welcome to Royal Golf View: Where Luxury Meets Majesty</strong>
            At Royal Golf View, we understand that luxury extends beyond the four walls of your home.
            ...
            Royal Golf View is not just a place to live; it&apos;s a lifestyle.
        ...
        <article>
          ...
          <p>
            <span>
              To curate homes, not just houses. We believe your living space should be an extension of yourself, a sanctuary that reflects your unique personality and aspirations. At Royal Golf View, every detail, from the spacious layouts to the premium finishes, is meticulously chosen to foster a sense of belonging and unparalleled comfort.
            </span>
            <span>
              To elevate the everyday. We understand that luxury lies not just in grand gestures, but also in the finer details. From the infinity pool shimmering under the golden sun to the meticulously landscaped gardens offering a haven of tranquility, every aspect of Royal Golf View is designed to elevate your day-to-day experience.
            </span>
            <span>
              To foster a community of like-minded individuals. Royal Golf View is more than just a collection of residences; it&apos;s a thriving community where residents can connect, share experiences, and forge lasting bonds. Our curated amenities and thoughtfully designed social spaces provide the perfect backdrop for fostering connections and creating memories that will last a lifetime.
            </span>
          </p>
        </article>
      </section>

...
export const galleryListB = [
  ...
  { tag: 'Front View', src: 'https://res.cloudinary.com/dvnemzw0z/image/upload/v1705695728/RGV/comView6_vqsybj.jpg' },
  { tag: 'Front View', src: 'https://res.cloudinary.com/dvnemzw0z/image/upload/v1705695726/RGV/comView2_st9ut2.jpg' },
  { tag: 'Front View', src: 'https://res.cloudinary.com/dvnemzw0z/image/upload/v1705695727/RGV/comView1_eubbrw.jpg' },
